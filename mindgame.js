...
ViewScoreTable.postFb = function(){
	FB.ui(
    {
			...
			description:( '' + GameManager.TheGame.MindGame.Score + 'poena za ' + GameManager.TheGame.MindGame.Timer + ' sekuni sa ' +GameManager.TheGame.MindGame.Clicks+' klikova!'),
...
ViewScoreTable.postTw = function(){
    ...
    url += 'I played memory game and score ' + GameManager.TheGame.MindGame.Score + ' in ' + GameManager.TheGame.MindGame.Clicks + ' clicks within ' + GameManager.TheGame.MindGame.Timer + ' sec!! ';
